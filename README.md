...
![Current Version](https://img.shields.io/badge/Version-1.0.0-brightgreen)
...
## Usage
```shell
docker pull ghcr.io/ejsuncy/sense_energy_prometheus_exporter:1.0.0
```
...
ghcr.io/ejsuncy/sense_energy_prometheus_exporter:1.0.0
```
