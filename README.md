...
![Current Version](https://img.shields.io/badge/Version-0.7.0a-brightgreen)
...
## Usage
```shell
docker pull ghcr.io/ejsuncy/sense_energy_prometheus_exporter:0.7.0a
```
...
ghcr.io/ejsuncy/sense_energy_prometheus_exporter:0.7.0a
```
...
spec:
  ...
  template:
    ...
    spec:
      containers:
      - image: ghcr.io/ejsuncy/sense_energy_prometheus_exporter:0.7.0a
        name: sense
        resources:
          limits:
            cpu: 1000m
