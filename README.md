...
![Current Version](https://img.shields.io/badge/Version-0.4.0-brightgreen)
...
## Usage
```shell
docker pull ghcr.io/ejsuncy/sense_energy_prometheus_exporter:0.4.0
```
...
ghcr.io/ejsuncy/sense_energy_prometheus_exporter:0.4.0
```
...
spec:
  ...
  template:
    ...
    spec:
      containers:
      - image: ghcr.io/ejsuncy/sense_energy_prometheus_exporter:0.4.0
        name: sense
        resources:
          limits:
            cpu: 1000m
