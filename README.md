...
![Current Version](https://img.shields.io/badge/Version-1.1.0a-brightgreen)
...
## Usage
```shell
docker pull ghcr.io/ejsuncy/sense_energy_prometheus_exporter:1.1.0a
```
...
ghcr.io/ejsuncy/sense_energy_prometheus_exporter:1.1.0a
```
